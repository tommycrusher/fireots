local mType = Game.createMonsterType("Devil Flamebeast")
local monster = {}

monster.description = "Devil Flamebeast"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{text = "I AM DEVIL FLAMEBEAST, LORD OF THE FIRE... AND YOU ARE LOST!", yell = true},
	{text = "MY SEED IS FEAR AND MY HARVEST ARE YOUR SOULS!", yell = true},
	{text = "THE FLAME COMES AND BURN YOU!", yell = true},
	{text = "MAGEBOMB! LOOK AT THE DESTRUCTION I AM CAUSING IN YOUR NAME!", yell = true}
}
