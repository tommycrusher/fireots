...
monster.loot = {
	...
	{name = "white pearl", chance = 12500, maxCount = 35},
        {id=2456, chance=6666},
        {id=2544, maxCount=15, chance=10000},
        {id=2546, maxCount=5, chance=10000},
        {id=2147, maxCount=2, chance=3333},
        {id=2675, maxCount=4, chance=6666},
        {id=2690, maxCount=4, chance=6666},
