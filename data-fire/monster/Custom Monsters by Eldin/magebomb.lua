...
monster.voices = {
	interval = 5000,
	chance = 10,
	{text = "You fear fire, I can feel it!", yell = true},
	{text = "Feel the heat!", yell = true},
	{text = "HOT EH??", yell = true},
...
monster.summons = {
    {name="Devil Flamebeast", interval= 5000, chance= 100}
}
