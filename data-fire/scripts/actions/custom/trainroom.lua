local trainRoom = Action()
function trainRoom.onUse(cid, item, frompos, item2, topos)
...
-- End of editable Variabels
    ...
    if (emptyRoom == true) then
        ...
        doPlayerSendTextMessage(cid, 22, "This room is occuped.")
    end
-- <end> Training Room script by Alreth.

    return true
end 
trainRoom:aid(4211, 4212, 4213, 4214)
trainRoom:register()
