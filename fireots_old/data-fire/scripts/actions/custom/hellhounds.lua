local hellhounds = Action()
function hellhounds.onUse(cid, item, frompos, item2, topos)
gateposu = {x=232, y=2055, z=11, stackpos=1}
gateposd = {x=232, y=2056, z=11, stackpos=1}
gatepost = {x=233, y=2055, z=11, stackpos=1}
gateposq = {x=233, y=2056, z=11, stackpos=1}
