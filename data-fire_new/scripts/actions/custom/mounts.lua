...
local t = {
	[2282] = {article='a' ,name='wolf', text='Mount, wolf!', dtext='Demount, wolf!', s=100, condition=wolfCondition},
}      
local mountsWolf = Action()
function mountsWolf.onUse(cid, item, fromPosition, itemEx, toPosition)
