local config = {
    ...
    -- vocation requirement, positions and item configuration
    {
        vocations = {1, 5, 9},
        itemId = 2175,
        playerPos = {x=41, y=2084, z=8},
        newPos = {x=35, y=2123, z=8},
        itemPos = {x=42, y=2084, z=8}
    },
 
    {
        vocations = {2, 6, 10},
        itemId = 2674,
        playerPos = {x=31, y=2084, z=8},
        newPos = {x=33, y=2123, z=8},
        itemPos = {x=30, y=2084, z=8}
    },
 
    {
        vocations = {3, 7, 11},
        itemId = 2455,
        playerPos = {x=26, y=2087, z=8},
        newPos = {x=35, y=2122, z=8},
        itemPos = {x=36, y=2088, z=8}
    },
 
    {
        vocations = {4, 8, 12},
        itemId = 2376,
        playerPos = {x=36, y=2080, z=8},
        newPos = {x=33, y=2122, z=8},
        itemPos = {x=36, y=2079, z=8}
    }
}
local desertQuest = Action()
function desertQuest.onUse(cid)
    local players = {}
