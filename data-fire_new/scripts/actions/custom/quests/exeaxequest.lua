local eaQuest = Action()
function eaQuest.onUse(cid, item, fromPosition, itemEx, toPosition)

   	if item.uid == 15901 then
   		queststatus = getPlayerStorageValue(cid,50089)
   		if queststatus == -1 then
   			doPlayerSendTextMessage(cid,MESSAGE_INFO_DESCR, "You have found Executioner.")
...
eaQuest:uid(15901, 15902, 15903, 15904)
eaQuest:register()
